...
public class SelectedCoinController {
    ...
    public ResponseEntity<ResponseSelectedCoinDTO> create(@AuthenticationPrincipal User user,
        ...
        ResponseSelectedCoinDTO result = selectedCoinService.create(user, tradingBotId, selectedCoinMarketsStrategyId, requestSelectedCoinDTO);
    ...
    public ResponseEntity<List<ResponseSelectedCoinDTO>> getAll(@AuthenticationPrincipal User user,
        ...
        return ResponseEntity.ok(selectedCoinService.getAll(user, tradingBotId, selectedCoinMarketsStrategyId));
    }
    ...
    public ResponseEntity<ResponseSelectedCoinDTO> get(@AuthenticationPrincipal User user,
        ...
        return ResponseEntity.ok(selectedCoinService.get(user, tradingBotId, selectedCoinMarketsStrategyId, id));
    }
    ...
    public ResponseEntity<ResponseTradingBotDTO> delete(@AuthenticationPrincipal User user,
        ...
        selectedCoinService.delete(user, tradingBotId, selectedCoinMarketsStrategyId, id);
